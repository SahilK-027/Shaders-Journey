...
import "./style.css";
import texture from "./texture3.jpg";
...
class ShaderRenderer {
  ...
  initGeometry() {
    ...
    const textureImg = new THREE.TextureLoader().load(texture);
    textureImg.wrapS = THREE.MirroredRepeatWrapping;
    textureImg.wrapT = THREE.MirroredRepeatWrapping; 
